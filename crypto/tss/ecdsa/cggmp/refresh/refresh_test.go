...
var (
	...
	sh = "68001589726001038091822961832266653767784731402079833928014379917710919752684"
	sh2= "110158783244454619462689368097750875544919593780282860478257655632114657019989"
...
func dkgresult() (*dkg.Result) {
	...
	pubkey, _ := pt.NewECPoint(elliptic.Secp256k1(), x, y)
